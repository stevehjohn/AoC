...
public class Part2 : Base
{
    ...
    private void PerformCycle()
    {
        ...
        // MoveRocks(r => r.Y < Rows - 1, (rock, other) => other.X == rock.X && other.Y > rock.Y, p => p.Y = Rows - 1, (rock, other) => rock.Y = other.Y - 1);
        //
        // MoveRocks(r => r.X < Columns - 1, (rock, other) => other.Y == rock.Y && other.X < rock.X, p => p.X = Columns - 1, (rock, other) => rock.Y = other.X - 1);
    }
}